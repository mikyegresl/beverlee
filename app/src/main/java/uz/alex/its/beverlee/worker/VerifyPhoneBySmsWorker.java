...
public class VerifyPhoneBySmsWorker extends Worker {
    private final Context context;

    public VerifyPhoneBySmsWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            final Response<Void> response = RetrofitClient.getInstance(context).verifySms();
    ...
    private static final String TAG = VerifyPhoneBySmsWorker.class.toString();
}
