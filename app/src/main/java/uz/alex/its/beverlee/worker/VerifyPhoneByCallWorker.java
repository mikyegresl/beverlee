...
public class VerifyPhoneByCallWorker extends Worker {
    private final Context context;

    public VerifyPhoneByCallWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private static final String TAG = VerifyPhoneByCallWorker.class.toString();
}
