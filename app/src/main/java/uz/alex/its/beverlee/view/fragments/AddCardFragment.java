...
public class AddCardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View root = inflater.inflate(R.layout.fragment_add_card, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cardNameEditText.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                nestedScrollView.postDelayed(() -> {
                    nestedScrollView.smoothScrollTo(0, addCardBtn.getBottom());
                }, 100);
        ...
        addCardBtn.setOnClickListener(v -> {
            addCardBtn.startAnimation(bubbleAnimation);
            addCardBtn.postOnAnimationDelayed(() -> {
                if (getActivity() != null) {
        ...
        parentLayout.getViewTreeObserver().addOnGlobalLayoutListener(() -> {
            final ConstraintLayout.LayoutParams layoutParams = (ConstraintLayout.LayoutParams) addCardBtn.getLayoutParams();
            ...
            addCardBtn.setLayoutParams(layoutParams);
        });
    }
}